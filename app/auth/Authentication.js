...
var serviceAccount = require("../../talent-book-firebase-secret.json");
//var firebase = new Firebase("https://talent-book.firebaseio.com/");
...
function authenticate(authCallback) {
    /*admin.authWithCustomToken(token, function(error, authData) {
        authCallback(error, authData);
    });*/
}
authenticate(function(error, authData){
